...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/ok/icons/check.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addemployer.setIcon(icon5)
        self.addemployer.setIconSize(QtCore.QSize(30, 30))
        self.addemployer.setObjectName("addemployer")
        self.gridLayout_2.addWidget(self.addemployer, 3, 2, 1, 1)
...
"}")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/ok/icons/trash.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.delete_2.setIcon(icon6)
        self.delete_2.setIconSize(QtCore.QSize(30, 30))
        self.delete_2.setObjectName("delete_2")
        self.gridLayout_2.addWidget(self.delete_2, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "new admin"))
...
import views.icons.img_rc as img_rc

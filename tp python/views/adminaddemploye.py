...
# Form implementation generated from reading ui file 'views\ui\addemployer.ui'
#
...
"}")
        ...
        self.grade = QtWidgets.QLineEdit(self.frame_2)
        self.grade.setMinimumSize(QtCore.QSize(400, 25))
        self.grade.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.grade, 11, 2, 1, 1)
        self.adresse = QtWidgets.QLineEdit(self.frame_2)
        self.adresse.setMinimumSize(QtCore.QSize(400, 25))
        self.adresse.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.adresse, 6, 2, 1, 1)
        self.numerotel = QtWidgets.QLineEdit(self.frame_2)
        self.numerotel.setMinimumSize(QtCore.QSize(400, 25))
        self.numerotel.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.numerotel.setFont(font)
        self.numerotel.setStyleSheet("QLineEdit {\n"
"    color:rgb(255,255,255);\n"
"    border:2px solid rgb(51,51,51);\n"
"    border-radius:4px;\n"
"    background:rgb(51,51,51);\n"
...
"    background:rgb(112,112,112);\n"
"}")
        self.numerotel.setObjectName("numerotel")
        self.gridLayout_2.addWidget(self.numerotel, 8, 2, 1, 1)
        self.service = QtWidgets.QComboBox(self.frame_2)
        self.service.setObjectName("service")
        self.gridLayout_2.addWidget(self.service, 10, 2, 1, 1)
        self.dateEdit = QtWidgets.QDateEdit(self.frame_2)
        self.dateEdit.setStyleSheet("color: rgb(255, 255, 255);")
        self.dateEdit.setObjectName("dateEdit")
        self.gridLayout_2.addWidget(self.dateEdit, 9, 2, 1, 1)
        ...
        self.nom.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.nom, 0, 2, 1, 3)
        ...
        self.sexe = QtWidgets.QComboBox(self.frame_2)
        self.sexe.setObjectName("sexe")
        self.sexe.addItem("")
        self.sexe.addItem("")
        self.gridLayout_2.addWidget(self.sexe, 5, 2, 1, 1)
        self.prenom = QtWidgets.QLineEdit(self.frame_2)
        self.prenom.setMinimumSize(QtCore.QSize(400, 25))
        self.prenom.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.prenom, 2, 2, 1, 3)
        ...
        self.postnom.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.postnom, 1, 2, 1, 3)
        ...
        self.email.setMinimumSize(QtCore.QSize(400, 25))
        self.email.setMaximumSize(QtCore.QSize(500, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.email, 7, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.delete_2, 12, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.addemployer, 12, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_17.setText(_translate("MainWindow", "grade:"))
        self.label_15.setText(_translate("MainWindow", "dare naissance:"))
        self.label_16.setText(_translate("MainWindow", "service:"))
        self.label_12.setText(_translate("MainWindow", "addresse:"))
        self.label_13.setText(_translate("MainWindow", "sexe:"))
        self.label_11.setText(_translate("MainWindow", "numero tel:"))
        self.sexe.setItemText(0, _translate("MainWindow", "M"))
        self.sexe.setItemText(1, _translate("MainWindow", "F"))
        self.label_3.setText(_translate("MainWindow", "post nom :"))
        self.label_14.setText(_translate("MainWindow", "email :"))
        self.label_2.setText(_translate("MainWindow", "nom :"))
        self.label_4.setText(_translate("MainWindow", "prenom:"))

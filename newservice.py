...
# Form implementation generated from reading ui file 'views/new swevice.ui'
#
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/python/icons/check.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/python/icons/trash.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
